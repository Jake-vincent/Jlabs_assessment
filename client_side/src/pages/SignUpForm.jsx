  ...
  return (
    <div className="SignUpForm">
      ...
      <form className="form-SignUpForm" onSubmit={handleSubmit}>
        ...
        {error && (
          <p className="p-SignUpForm" style={{ color: "red" }}>
            {error}
          </p>
        )}
        <br />
        <button className="btn-SignUpForm" type="submit">
          Signup
        </button>
      </form>
      <br />
      <p>
        ...
        <Link className="link-SignUpForm" to="/login">
          SignIn now.
        </Link>
      </p>
    </div>
